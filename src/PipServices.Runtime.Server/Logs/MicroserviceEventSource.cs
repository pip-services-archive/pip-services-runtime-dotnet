...
{
    [EventSource(Name = "PipServices-MicroserviceEventSource")]
    public sealed class MicroserviceEventSource : EventSource
    {
        public static readonly MicroserviceEventSource Current = new MicroserviceEventSource();

        static MicroserviceEventSource()
        {
        ...
        private MicroserviceEventSource() { }
